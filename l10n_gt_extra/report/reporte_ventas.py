...
class ReporteVentas(models.AbstractModel):
    ...
    def lineas(self, datos):
        ...
        for f in facturas:
            ...
            if ('serie_fel' in f.fields_get()):
                fel_serie = f.serie_fel

            if ('numero_fel' in f.fields_get()):
                fel_numero = f.numero_fel        
        ...
        if datos['resumido']:
            ...
            for l in lineas_resumidas.values():
                ...
                l['ultima_serie'] = l['facturas'][-1]
                l['ultimo_numero'] = l['facturas'][-1]
